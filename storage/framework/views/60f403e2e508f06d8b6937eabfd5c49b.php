...
<?php if($get == 'saved'): ?>
    <table class="messenger-list-item" data-contact="<?php echo e(Auth::user()->id); ?>">
        <tr data-action="0">
            ...
            <td>
                <p data-id="<?php echo e(Auth::user()->id); ?>" data-type="user">Pesan Tersimpan <span>You</span></p>
...
<?php /**PATH C:\xampp\htdocs\real-time-chat-app\resources\views/vendor/Chatify/layouts/listItem.blade.php ENDPATH**/ ?>